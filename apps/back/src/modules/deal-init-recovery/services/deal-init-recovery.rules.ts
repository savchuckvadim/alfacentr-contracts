...
/**
 * Дата выката признака обработки, полночь по Новосибирску. Сделки, созданные
 * раньше, приняты без него, и по пустоте их не отличить от недошедших
 * (у УП-заявок товаров и участников нет в норме). Повторный прием задвоил бы
 * таймлайн и поиск компании — поэтому все, что старше этой даты, не трогаем
 */
export const RECOVERY_NOT_BEFORE = new Date('2026-09-08T00:00:00+07:00');
/**
