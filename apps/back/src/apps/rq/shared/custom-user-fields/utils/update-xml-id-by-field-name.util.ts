...
import { BASE_OTHER_FIELD_NAME, BASE_OTHER_FIELD_XML_ID } from "../consts/base-other-field.const";
...
export const mutateCustomFieldXmlIdByName = (customField: Partial<CustomField>) => {
