...
import { BxParticipantsDataKeys, getParticipantSelect, getParticipantSelectItemByValue, IParticipant } from "@alfa/entities"
...
export const ParticipantEditContent = ({
    ...
    const { cancelEditable, changeEditable, editParticipantTopic, updateParticipant, name, isEditLoading } = useEditParticipant(editable.id)
    ...
    return (<>
        ...
        {/* ППК программы */}
        <Card className={`h-fit transition-all duration-300 ease-in-out ${isPpk
