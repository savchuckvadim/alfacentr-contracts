...
import { EvsRqItem, RqItem, RQ_TYPE, CONTRACT_LTYPE, SupplyTypesType, filterFieldItems, useBxRqEditBase, useBxRq } from '@workspace/bx-rq'
...
export const BxRqBaseEdit = ({
  ...
  return (
    <>
      ...
      {creating && creating.fields && creating.fields.length > 0 && <BxRqEditModal
