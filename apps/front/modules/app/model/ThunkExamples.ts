...
>('app/basicThunk', async (payload, { dispatch, getState, extra }) => {
...
>('app/noParamsThunk', async (_, { dispatch, getState, extra }) => {
    const state = getState();
    const { getWSClient } = extra;
...
>('app/conditionalThunk', async (_, { dispatch, getState, extra }) => {
    const state = getState();
    const { getWSClient } = extra;
...
>('app/chainThunk', async (_, { dispatch, getState, extra }) => {
    const state = getState();
    const { getWSClient } = extra;
