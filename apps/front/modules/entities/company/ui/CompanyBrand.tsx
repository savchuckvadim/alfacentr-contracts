...
export const CompanyBrand = () => {
    ...
    return <Link target="_blank" href={url}  className="cursor-pointer text-xl font-semibold text-foreground hover:text-blue-600 transition-colors">
        {company?.TITLE} {inn && <span className="text-sm text-gray-500">{inn}</span>}
    </Link>;
};