...
const participantSlice = createSlice({
    ...
    reducers: {
        ...
        activateEditable: (
            state,
            action: PayloadAction<{ participantId: number }>,
        ) => {
            const searchedParticipant = state.items.find(
    ...
    extraReducers: builder => {
        ...
        builder.addCase(
            fetchParticipants.rejected,
            (state: IParticipantState, action) => {
                state.loading = false;
        ...
        builder.addCase(
            ...
            (state: IParticipantState, action: PayloadAction<number>) => {
