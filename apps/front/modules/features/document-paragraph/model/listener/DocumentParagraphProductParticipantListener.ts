...
import {
    addParticipant, deleteParticipant, fetchParticipants,
...
export function setupDocumentParagraphProductParticipantListener(listenerMiddleware: ListenerMiddlewareInstance) {
