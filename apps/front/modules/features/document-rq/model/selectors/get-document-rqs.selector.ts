...
export const getDocumentRqs = createSelector(
    ...
    documentRq =>
        getForDocumentItems(
            documentRq.client as DocumentRqAgent<
                RQ_TYPE.FIZ | RQ_TYPE.ORGANIZATION
            >,
            documentRq.client?.type as RQ_TYPE.FIZ | RQ_TYPE.ORGANIZATION,
            documentRq.provider as DocumentRqAgent<RQ_TYPE.ORGANIZATION>,
        ),
);
