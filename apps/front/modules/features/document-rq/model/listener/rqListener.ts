...
import { RQ_TYPE, setCurrentItem, setCurrentRqItems, setFetched } from "@workspace/bx-rq"
...
export function setupRqListener(listenerMiddleware: ListenerMiddlewareInstance) {
    ...
    listenerMiddleware.startListening({
        ...
        effect: async (action, listenerApi) => {
            ...
            // Добавляем задержку перед паузой (например, 1000ms = 1 секунда)
