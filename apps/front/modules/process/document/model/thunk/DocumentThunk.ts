...
import { getRedirect } from '../utils/get-redirect.util';


import { IDealFieldsData } from "@/modules/entities";
...
const getGenerateDocumentData = (
    state: RootState,
    socketId: string,
): IRequestDocumentGenerateType => {

    const { needEmail } = state.communications.confirm;
    ...
    const userEmail = 'ppk@alfasibir.ru';
