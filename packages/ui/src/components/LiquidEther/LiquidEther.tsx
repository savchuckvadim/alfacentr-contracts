...
`;
        ...
        class Advection extends ShaderPass {
            ...
            update(...args: any[]) {
                ...
                if (!uniforms) return;
                if (typeof dt === 'number') uniforms.dt!.value = dt;
                if (typeof isBounce === 'boolean') this.line.visible = isBounce;
                if (typeof BFECC === 'boolean') uniforms.isBFECC!.value = BFECC;
                super.update();
            }
        }
        ...
        class Viscous extends ShaderPass {
            ...
            update(...args: any[]) {
                ...
                if (typeof viscous === 'number') uniforms.v!.value = viscous;
        ...
        class Divergence extends ShaderPass {
            ...
            update(...args: any[]) {
                ...
                const uniforms = this.uniforms;
                if (uniforms && vel) {
                    uniforms.velocity!.value = vel.texture;
                }
                super.update();
            }
        }
        ...
        class Poisson extends ShaderPass {
            ...
            update(...args: any[]) {
                ...
                for (let i = 0; i < iter; i++) {
                    ...
                    if (uniforms) uniforms.pressure!.value = p_in.texture;
