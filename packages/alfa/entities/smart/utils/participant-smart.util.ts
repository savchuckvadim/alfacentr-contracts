import { AlfaParticipantSmartItemUserFieldsEnum, BxParticipantsDataKeys, fieldTypes, IParticipant, IParticipantField, IParticipantSelectItem } from "../participant.interface";
...
export const getParticipantSelect = (fieldCode: BxParticipantsDataKeys.format  | BxParticipantsDataKeys.is_ppk) => {
...
export const getParticipantSelectItemByValue = (fieldCode: BxParticipantsDataKeys.format  | BxParticipantsDataKeys.is_ppk, value: string | number) => {
    switch (fieldCode) {
        case BxParticipantsDataKeys.format:
            const searchedInfo = formatSelect.find(item => item.value === value)
            return searchedInfo;


        case BxParticipantsDataKeys.is_ppk:
            const isPpkSearchedInfo = isPpkSelect.find(item => item.value === value)
