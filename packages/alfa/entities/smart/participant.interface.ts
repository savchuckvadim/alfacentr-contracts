...
export type IParticipantField<
    T extends AlfaParticipantSmartItemUserFieldsEnum,
> = T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Name
    ? IParticipantNameField
    : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Email
      ? IParticipantEmailField
      : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12AddressForUdost
        ? IParticipantAddressForUdostField
        : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Phone
          ? IParticipantPhoneField
          : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Comment
            ? IParticipantCommentField
            : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Format
              ? IParticipantFormatField
              : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12IsPpk
                ? IParticipantIsPpkField
                : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12AccountantGos
                  ? IParticipantAccountantGosField
                  : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12AccountantMedical
                    ? IParticipantAccountantMedicalField
                    : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Zakupki
                      ? IParticipantZakupkiField
                      : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Kadry
                        ? IParticipantKadryField
                        : T extends AlfaParticipantSmartItemUserFieldsEnum.ufCrm12Corruption
