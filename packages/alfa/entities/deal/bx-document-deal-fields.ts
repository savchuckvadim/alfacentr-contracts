import { EnumDealCurrentDocumentFieldCode, EnumDealDocumentFieldCode } from "./bx-document-deal-fields.type";
...
const fields = {
    ...
    [EnumDealDocumentFieldCode.PREFIX_DINMYC]: {
        id: "10226",
        bitrixId: "UF_CRM_8_PREFIX",
        type: "string",
        name: "Префикс",
        code: EnumDealDocumentFieldCode.PREFIX_DINMYC,
        multiple: false,
        mandatory: false
    },
...
export const currentDocumentFields = {
    ...
    [EnumDealCurrentDocumentFieldCode.CURRENT_ACT_WITHOUT_PT]: {
        "id": "10252",
        "bitrixId": "UF_CRM_8_DOCX_CURRENT_CONTRACT_NOT_PT",
        "type": "file",
        "name": "Текущий договор без печати",
        "code": EnumDealCurrentDocumentFieldCode.CURRENT_ACT_WITHOUT_PT,
        "multiple": false,
        "mandatory": false
    },
