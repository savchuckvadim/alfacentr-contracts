...
import { BxCatalogSchema, BxListSchema, BxRpaItemSchema, IBXItem, UserFieldConfigSchema } from "@bitrix/domain/";
import {
  CompanySchema,
  ContactSchema,
  DealSchema,
...
} from "@bitrix/domain/crm";


import { TasksSchema } from "@bitrix/domain/tasks/bx-tasks.schema";
import { ActivitySchema } from "@bitrix/domain/activity/bx-activity.schema";
import { FileSchema } from "@bitrix/domain/file/bx-file.schema";
import { CrmItemAddRequestType, CrmItemGetRequestType, CrmItemListRequestType, CrmUpdateItemRequestType } from "@bitrix/domain/crm/type/crm-request.type";
import { BxSmartTypeSchema } from "@bitrix/domain/crm/smart-type";
// import { FieldsEnumerationSchema } from "@bitrix/domain/crm";
