...
export class BxItemRepository {
    ...
    async updateBtch(cmdCode: string, id: number | string, entityTypeId: BitrixOwnerTypeId | string, data: { [key: string]: any }) {
    ...
    async delete(id: number | string, entityTypeId: string): Promise<IBitrixResponse<boolean>> {
        return await this.bxApi.callType(
            EBxNamespace.CRM,
            EBXEntity.ITEM,
            EBxMethod.DELETE,
    ...
    deleteBtch(cmdCode: string, id: number | string, entityTypeId: string): void {
